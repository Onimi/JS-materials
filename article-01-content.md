...
Обращаться к элементам массива можно с помощью номера элемента (нумерация элементов начинается с 0) и квадратных скобок:
```javascript
...
В JavaScript нет ограничения ни на количество элементов в обычном массиве, ни на тип элементов. Даже в том плане что два разных элемента из одного
массива могут быть различных типов.
